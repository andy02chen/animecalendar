...
const watchingDivHTML = ((userContext, handleData, unclickable, hideCheckBox, displayAnime, currAiringAnime, weeklyAnime, setDisplayAnime, setRenderAllComponents) => {
...
const renderContent = (userContext, setRenderAllComponents, setNumberOfWatchingAnime, handleData, setTrigger, notYetAiredList,planToWatchAnimeList,displayPlanToWatch,currAiringAnime, weeklyAnime, displayAnime, failedRequest,setPlanToWatch, setWeeklyAnime, setDisplayAnime, setFailedRequest, setGotRequest, setNotYetAiredList, setPlanToWatchAnimeList, setCurrAiringAnime) => {
    ...
    if(failedRequest) {
        ...
        if(document.getElementById('search-value').value !== '') {
            ...
            if(displayAnime.length > 0 && displayPlanToWatch.length === 0) {
                return(
                    <>
                        {displayAnime.length > 0 ? watchingDivHTML(userContext, handleData, true, true, displayAnime, currAiringAnime, weeklyAnime, setDisplayAnime, setRenderAllComponents) : null}
                    </>
                );
            }
            ...
            // Match in Both div
                ...
                return(
                    <>
                        {displayAnime.length > 0 ? watchingDivHTML(userContext, handleData, false, true, displayAnime, currAiringAnime, weeklyAnime, setDisplayAnime, setRenderAllComponents) : null}
        ...
        // Case when user only has anime in watchlist and not any in plan to watch
            ...
            return(
                <>
                    {watchingDivHTML(userContext, handleData, true, currAiringAnime.length === 0, displayAnime, currAiringAnime, weeklyAnime, setDisplayAnime, setRenderAllComponents)}
                </>
            );
        // case when user only has anime in plan to watch
            ...
            return(
                <>
                    {displayAnime.length > 0 ? watchingDivHTML(userContext, handleData, false, false, displayAnime, currAiringAnime, weeklyAnime, setDisplayAnime, setRenderAllComponents) : null}
...
function showTutorial() {
    document.getElementById('main-div').style.overflow = 'hidden';
    document.getElementById('tutorial-div').style.display = "flex";
    ...
    return(
        <>
                ...
                <div className='heading-top'>
                    ...
                    <div className='settings-dropdown' id='settings-dropdown'>
                        ...
                        <div className='settings-hide' id='settings-options-div' style={{display: 'none'}}>
                            ...
                            <button className='dropdown-btn' onClick={() => showTutorial()}>
                            <svg className='settings-div-icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 192 512"><path d="M48 80a48 48 0 1 1 96 0A48 48 0 1 1 48 80zM0 224c0-17.7 14.3-32 32-32l64 0c17.7 0 32 14.3 32 32l0 224 32 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 512c-17.7 0-32-14.3-32-32s14.3-32 32-32l32 0 0-192-32 0c-17.7 0-32-14.3-32-32z"/></svg>
                                &nbsp;Tutorial
                            </button>
            ...
            <div className='progress-div'>
                    {gotRequest ?
                        renderContent(userContext, setRenderAllComponents, setNumberOfWatchingAnime, handleData, setTrigger, notYetAiredList,planToWatchAnimeList,displayPlanToWatch,currAiringAnime, weeklyAnime, displayAnime, failedRequest,setPlanToWatch, setWeeklyAnime, setDisplayAnime, setFailedRequest, setGotRequest, setNotYetAiredList, setPlanToWatchAnimeList, setCurrAiringAnime)
                        :
                        <div className='message-div'>
